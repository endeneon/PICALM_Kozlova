...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "GABA_scATAC_18_lines_0hr_DP20_FDR_005.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_4_annovar <-
...
write.table(ASoC_df_4_annovar,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "GABA_scATAC_18_lines_0hr_DP20_FDR_005_4_annovar.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
...
ggplot(ASoC_df_plot, aes(x = ratio,
  ...
  ggtitle(paste("SNPs from de novo call\n", 
                "18 lines, GABA 0hr, 87296 SNPs, DP >= 20, \nmax DP=1879, median DP=39, FDR<0.05=423\n",
                "Nratio < 0.5 = 47664, Nratio >= 0.5 = 39605"))
...
ggplot(ASoC_df_plot, aes(x = ratio,
  ...
  theme_classic() +
  theme(legend.position = "none") +
  ggtitle(paste("NEFM+ 0hr\n", 
                "18 lines, 102072 SNPs, DP >= 20, \nmax DP=1550, median DP=38, FDR<0.05=387\n"))
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_0hr_DP20_full_list.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_writeout <-
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_0hr_DP20_FDR_005.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_4_annovar <-
...
write.table(ASoC_df_4_annovar,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_0hr_DP20_FDR_005_4_annovar.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "GABA_scATAC_18_lines_1hr_DP20_full_list.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_writeout <-
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "GABA_scATAC_18_lines_1hr_DP20_FDR_005.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_4_annovar <-
...
write.table(ASoC_df_4_annovar,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "GABA_scATAC_18_lines_1hr_DP20_FDR_005_4_annovar.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMp_scATAC_18_lines_1hr_DP20_full_list.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_writeout <-
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMp_scATAC_18_lines_1hr_DP20_FDR_005.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_4_annovar <-
...
write.table(ASoC_df_4_annovar,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMp_scATAC_18_lines_1hr_DP20_FDR_005_4_annovar.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_1hr_DP20_full_list.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_writeout <-
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_1hr_DP20_FDR_005.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_4_annovar <-
...
write.table(ASoC_df_4_annovar,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_1hr_DP20_FDR_005_4_annovar.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "GABA_scATAC_18_lines_6hr_DP20_full_list.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_writeout <-
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "GABA_scATAC_18_lines_6hr_DP20_FDR_005.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_4_annovar <-
...
write.table(ASoC_df_4_annovar,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "GABA_scATAC_18_lines_6hr_DP20_FDR_005_4_annovar.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMp_scATAC_18_lines_6hr_DP20_full_list.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_writeout <-
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMp_scATAC_18_lines_6hr_DP20_FDR_005.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_4_annovar <-
...
write.table(ASoC_df_4_annovar,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMp_scATAC_18_lines_6hr_DP20_FDR_005_4_annovar.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_6hr_DP20_full_list.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_writeout <-
...
write.table(ASoC_df_writeout,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_6hr_DP20_FDR_005.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
ASoC_df_4_annovar <-
...
write.table(ASoC_df_4_annovar,
            file = paste("/home/zhangs3/Data/FASTQ/Duan_Project_024/hybrid_output/SNP_18_liners_output_table",
                         "Glut_NEFMn_scATAC_18_lines_6hr_DP20_FDR_005_4_annovar.txt",
                         sep = '/'),
            row.names = F, col.names = T, 
            sep = "\t", quote = F)
