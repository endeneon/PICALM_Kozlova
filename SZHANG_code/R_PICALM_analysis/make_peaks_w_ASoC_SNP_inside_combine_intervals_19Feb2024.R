...
npglut_ASoC_SNPs[['hr_0']][npglut_ASoC_SNPs[["hr_0"]]$ID == "rs7928017", ]
npglut_ASoC_SNPs_assoc_peaks[['hr_0']][(npglut_ASoC_SNPs_assoc_peaks[['hr_0']]@seqnames == "chr11") &
                                         (npglut_ASoC_SNPs_assoc_peaks[['hr_0']]@ranges), ]

npglut_ASoC_SNPs[['hr_0']][npglut_ASoC_SNPs[["hr_0"]]$ID == "rs7178152", ]
npglut_ASoC_SNPs_assoc_peaks[['hr_0']][(npglut_ASoC_SNPs_assoc_peaks[['hr_0']]@seqnames == "chr11") &
                                         (npglut_ASoC_SNPs_assoc_peaks[['hr_0']]@ranges), ]


sum(master_vcf_list[['0hr_npglut']][[3]]$ID == "rs7178152")
sum(master_vcf_list[['1hr_npglut']][[3]]$ID == "rs7178152")
sum(master_vcf_list[['6hr_npglut']][[3]]$ID == "rs7178152")

sum(master_vcf_list[['0hr_nmglut']][[3]]$ID == "rs7178152")
sum(master_vcf_list[['1hr_nmglut']][[3]]$ID == "rs7178152")
sum(master_vcf_list[['6hr_nmglut']][[3]]$ID == "rs7178152")
