...
# load data
ASoC_df_raw <- 
  read_delim("vcf_merge/MG/output/MG_11_lines_merged_SNP_25May2022_DP15_4_R.txt", 
...
ASoC_df_table <- ASoC_df[, -c(7:28)]

# ## write out the table
# write.table(ASoC_df_table, file = "DP20_data_files/MG_11_lines_SNP_444K_25May2022.txt",
...
write.table(ASoC_df_table, 
            file = "MG_11_lines_SNP_FDR005_annovar_25May2022.txt",
            row.names = F, col.names = T, sep = "\t", quote = F)
