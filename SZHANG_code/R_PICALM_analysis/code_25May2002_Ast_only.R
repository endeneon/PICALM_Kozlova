...
# load data
ASoC_df_raw <- 
  read_delim("DP20_data_files/non_500bp_intersected/AST_merged_SNP_12_lines_in_peaks_only_03Jun2022_DP20_4_R.txt", 
...
ASoC_df_table <- ASoC_df[, -c(7:30)]

## write out the table
write.table(ASoC_df_table, file = "DP20_data_files/AST_12_lines_SNP_235K_06Jun2022.txt",
...
write.table(ASoC_df_table, 
            file = "AST_12_lines_500bp_SNP_FDR005_annovar_06Jun2022.txt",
            row.names = F, col.names = T, sep = "\t", quote = F)
