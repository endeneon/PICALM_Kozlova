...
# load iMG+iAst
iMG_Ast_raw <-
  read_delim("raw_data/OCRs_microglia_regulome_Kosoy.saf_featureCounts_03Jul2023.txt",
             delim = "\t", escape_double = FALSE, skip = 1,
             trim_ws = TRUE)
temp_rownames <-
...
master_metadata_table$cell_label[master_metadata_table$cell_label %in% "hMG"] <-
  "hMG-2"
master_metadata_table$cell_label[211:225][master_metadata_table$cell_label[211:225] %in% "hMG-2"] <- "hMG-1"
...
save.image("Kosoy_interval_5_celltypes_03Jul2023.RData")
