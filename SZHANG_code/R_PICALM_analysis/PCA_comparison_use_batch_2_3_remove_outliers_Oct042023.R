...
# ### remove outliers: CD04-A5-1_march; CD04-G3-2_August;
# ### CD04-A5-2_August,
df_metadata_4_DGE <-
  df_metadata_4_DGE[!df_metadata_4_DGE$sample_names %in%
                      c("CD04-A5-1_march",
...
df_master_4_DGE <-
  df_master_4_DGE[rownames(df_master_4_DGE) %in% gene_list_from_3_groups, ]
nrow(df_master_4_DGE)
...
save.image("Alena_batch_02_03_only_04Oct2023_correct.RData")
