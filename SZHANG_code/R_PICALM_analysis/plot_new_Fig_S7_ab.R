...
## Fig. S7a #####
df_raw <-
  read_excel("Batch_2_of_new_plots/new_S_Fig_7a_b.xlsx",
             sheet = 1)
...
# non-risk TrC - non-risk == 0  -0.3176     0.1549  -2.050    0.161
# risk - non-risk == 0           0.9174     0.1449   6.333   <0.001 ***
#   risk TrC - non-risk == 0      -0.1016     0.1549  -0.656    0.846
