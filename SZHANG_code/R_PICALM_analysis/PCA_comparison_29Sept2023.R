...
iPS_microglia_meta <-
  read_csv("STAR_aligned/GSE173316_iPS_microglia_metadata.txt")
iPS_microglia_meta$cell_type_group <-
  str_c(iPS_microglia_meta$source_name,
        iPS_microglia_meta$Group,
        sep = "_")
human_microglia_meta <-
  read_csv("STAR_aligned/human_microglia_RNAseq_metadata.txt")
...
Alena_Nov2022_meta$`Sample Name`
...
df_metadata_raw$sample_type[9:11] <- "risk"
df_metadata_raw$sample_type[12:14] <- "non-risk"
