...
print(path)
bam_files = []
for each_file in glob.glob(path + '**/GA*WASPed.bam', recursive=True):
    print(each_file)
    bam_files.append(each_file)

peak_file = ["./GA_20_lines_17Jun2021_peaks.narrowPeak"]
...
FRiP_count.to_csv("GA_NVME_all_lines_FRiP.txt",
                  sep = "\t")
